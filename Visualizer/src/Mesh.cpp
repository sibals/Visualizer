...
bool Mesh::Initialize(float size)
{
	...
	*/
	...
	if (!this->texture_shader.Initialize("shaders/texture_shader.vert", "shaders/texture_shader.frag"))
		return false;

	if (!this->spotlight_wireframe_shader.Initialize("shaders/spotlight_wireframe_shader.vert", "shaders/spotlight_wireframe_shader.frag", "shaders/spotlight_wireframe_shader.geo"))
		return false;
...
void Mesh::Draw(string shaderName, const mat4 & projection, mat4 view, const ivec2 & size, Lights & lights,  const float time)
{
