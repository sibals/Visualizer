...
void Spline::GeneratePoints(vec3 startPoint, vec3 endPoint)
{
	...
	m_controlPoint1 = (2.0f/3.0f)*m_startPoint + (1.0f/3.0f)*m_endPoint + vec3(0.0f, rand() % 5 - 2, rand() % 4 - 2);
	m_controlPoint2 = (1.0f/3.0f)*m_startPoint + (2.0f/3.0f)*m_endPoint + vec3(0.0f, rand() % 5 - 2, rand() % 4 - 2);
}
