...
bool Background::Initialize()
{
	...
	if (!this->shader.Initialize("shaders/background_gradient.vert", "shaders/background_gradient.frag"))
		return false;
...
void Background::Draw(const ivec2 & size, vec4 color)
{
...
void Background::Draw(string shaderName, const mat4 & projection, mat4 modelview, const ivec2 & size, Lights & lights, const float time)
{
	assert(false);
}
